...
/*    JavaScript 7th Edition
      ...
      Author: Katialy Ashley Metsanou
      Date:06-22-2023
...
function createLightbox() {
   ...
   function createOverlay() {
      ...
      addToFavoritesButton.onclick = function(){
        addToFavorites(overlayImage.src, overlayCaption.textContent);
      };
     figureBox.appendChild(addToFavoritesButton)
   
   
     function addToFavorites(imageSrc, caption){
       let favoritess=document.getElementById("favorites");
       let favoritesCount = favoritess.children.length;
         ...
         let img = favoritess.children[i].querySelector('img');
         ...
         favoritess.removeChild(imageB);
         };
   
         let imageB = document.createElement("div");
         imageB.classList.add("favorites");
         imageB.appendChild(image);
         imageB.appendChild(removeButton);
     
         favoritess.appendChild(imageB);
         imageB.style.position ="relative";
         imageB.style.left = "15%";
   
     }
   
   }
   
   // Event listener to call the setupGallery function when the window is loaded
   ...
   function setupGallery() {
      ...
      // Add images from the imgFiles array to the slide box
      ...
      // Function to create a modal window with the clocked image
      function createModal() {
         // Create modal window container
         let modalWindow = document.createElement("div");
         modalWindow.id = "activeModal";
          // Create figure box for image and caption
         let figureBox = document.createElement("figure");
        ...
        // Clone the clicked image
         ...
         // Create close box to close the modal window
         let closeBox = document.createElement("div");
         closeBox.id = "modalClose";
         closeBox.innerHTML = "&times;";
         closeBox.onclick = function() {
            // Removce the modal window from the document
            document.body.removeChild(modalWindow);
         }
         
         modalWindow.appendChild(closeBox);
         
         // Add the modal window to the document
